...
class DateSelection extends Component {
  ...
  shouldComponentUpdate = (nextProps, nextState) => {
    // only redner when toggle collapse, preventing re-render when parents state change
    if (nextState.isOpened !== this.state.isOpened) return true;
    return false;
  };

  render() {
    const tooltip = <Tooltip id="tooltip">Expand/Collapse</Tooltip>;
    return (
