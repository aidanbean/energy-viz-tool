...
module.exports = {
    ...
    dataPie, legendPie, dataSales, optionsSales, responsiveSales, legendSales, dataBar, optionsBar, responsiveBar, legendBar, HighChartsDummyData, optionsDummy // For charts (Search view)
};
